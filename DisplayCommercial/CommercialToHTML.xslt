<?xml version="1.0" encoding="utf-8"?>
  <xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="/">
      <h2>List of Companies commercial...</h2>
    ...
    <xsl:template match="c:commercial">
      ...
      <div style=" display: flex;   margin:15px; padding-left:2%; box-shadow: 0 4px 15px 0 rgba(0, 0, 0, 0.8), 0 6px 6px 0 rgba(0, 0, 0, .3); padding-bottom:5px; background-color: lightgreen;  width:20%">
